...
```{r}
fidget <- read.csv("https://raw.githubusercontent.com/nbussberg/STS2300-Fall2024/refs/heads/main/Data/fidget_spinners.csv") %>%
...
```{r}
airbnb <- read.csv("https://raw.githubusercontent.com/nbussberg/STS2300-Fall2024/refs/heads/main/Data/airbnb.csv")
```

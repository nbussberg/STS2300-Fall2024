...
According to a [People.com](https://people.com/travis-kelce-taylor-swift-improved-performance-nfl-8379432) article from last fall, Travis Kelce had been performing better when Taylor Swift attended his football games. From the article, Travis Kelce's brother says to him:
...
```{r}
kelce <- read.csv("https://raw.githubusercontent.com/nbussberg/STS2300-Fall2024/refs/heads/main/Data/kelce_stats_23.csv")
```

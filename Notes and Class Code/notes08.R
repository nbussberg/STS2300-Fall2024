...
sampling_dist_50 <- ggplot(my_phats_n50) + 
  geom_histogram(aes(x = prop_dem),
                 binwidth = 1/30,
                 color = "white") + 
  theme_classic() + 
...
sampling_dist_100 <- ggplot(my_phats_n100) + 
  geom_histogram(aes(x = prop_dem),
                 binwidth = 1/30,
                 color = "white") + 
  theme_classic() + 
...
sampling_dist_100 <- sampling_dist_100 + 
...
sampling_dist / sampling_dist_50 / sampling_dist_100

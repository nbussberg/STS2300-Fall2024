...
majors <- read.csv("https://raw.githubusercontent.com/nbussberg/STS2300-Fall2024/refs/heads/main/Data/MTH_STS_majors_long.csv")
...
ggplot(majors, aes(x = Year, y = Count, color = Major)) + 
  ...
  geom_point() + 
  labs(title = "Elon Math/Stats Dept Majors",
